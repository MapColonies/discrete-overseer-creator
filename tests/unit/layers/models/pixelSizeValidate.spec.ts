...
describe('pizelSizeValidate', function () {
  it('should return valid pixel size for zoom level 0', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(0) as number, infoData?.pixelSize as number);
  ...
  it('should return valid pixel size for zoom level 1', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(1) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 2', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(2) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 3', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(3) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 4', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(4) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 5', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(5) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 6', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(6) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 7', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(7) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 8', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(8) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 9', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(9) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 10', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(10) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 11', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(11) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 12', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(12) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 13', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(13) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 14', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(14) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 15', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(15) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 16', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(16) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 17', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(17) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 18', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(18) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 19', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(19) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 20', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(20) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
  ...
  it('should return valid pixel size for zoom level 21', async function () {
    ...
    const isValidPixelSize = isPixelSizeValid(zoomLevelToResolutionDeg(21) as number, infoData?.pixelSize as number);
    expect(isValidPixelSize).toBe(true);
  });
});
